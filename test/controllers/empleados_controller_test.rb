...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { apellidos: @empleado.apellidos, area_id: @empleado.area_id, codigo: @empleado.codigo, empresa_id: @empleado.empresa_id, nombres: @empleado.nombres }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { apellidos: @empleado.apellidos, area_id: @empleado.area_id, codigo: @empleado.codigo, empresa_id: @empleado.empresa_id, nombres: @empleado.nombres }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
