...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentario: @comentario.comentario, empleado_id: @comentario.empleado_id, ticket_id: @comentario.ticket_id, usuario_id: @comentario.usuario_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { comentario: @comentario.comentario, empleado_id: @comentario.empleado_id, ticket_id: @comentario.ticket_id, usuario_id: @comentario.usuario_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
